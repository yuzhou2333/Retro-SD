...
class TransformerModel(TransformerModelBase):
    ...
    def build_model(cls, args, task):
        ...
        cfg = TransformerConfig.from_namespace(args)
        # Modified by Eachan: I have to do this strange operation to pass the reaction_pairs and lang2id through
        cfg.reaction_pairs = getattr(args, "reaction_pairs", None)
        cfg.lang2id = getattr(args, "lang2id", None)
...
@register_model_architecture("transformer", "transformer_retro")
def transformer_retro(args):
    base_architecture(args)
