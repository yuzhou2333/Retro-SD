...
class MultilingualTransformerModel(FairseqMultiModel):
    ...
    def build_model(cls, args, task):
        ...
        src_langs = [lang_pair.split("-")[0] for lang_pair in task.model_reaction_pairs]
        tgt_langs = [lang_pair.split("-")[1] for lang_pair in task.model_reaction_pairs]
        ...
        for lang_pair, src, tgt in zip(task.model_reaction_pairs, src_langs, tgt_langs):
            encoders[lang_pair] = (
    ...
    @classmethod
    def _get_module_class(cls, is_encoder, args, reaction_dict, embed_tokens, langs):
        module_class = TransformerEncoder if is_encoder else TransformerDecoder
        return module_class(args, reaction_dict, embed_tokens)
