...
class OnlineBackTranslationTask(TranslationTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--valid-reaction-pairs', default=None, metavar='VALID_reaction_pairs',
    ...
    def __init__(self, args, common_dict, mono_langs, valid_reaction_pairs):
        super().__init__(args, common_dict, common_dict)
        self.common_dict = common_dict
        self.mono_langs = mono_langs
        self.valid_reaction_pairs = valid_reaction_pairs
    ...
    def setup_task(cls, args, **kwargs):
        ...
        valid_reaction_pairs = args.valid_reaction_pairs.split(",")

        # load dictionary
        dict_path = os.path.join(paths[0], "dict.txt")
        common_dict = cls.load_dictionary(dict_path)

        return cls(args, common_dict, mono_langs, valid_reaction_pairs)
    ...
    def load_translation_dataset(
        ...
        assert len(self.valid_reaction_pairs) == 1, "For now..."
        valid_lang_pair = self.valid_reaction_pairs[0]
