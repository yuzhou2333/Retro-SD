...
def get_parser(desc, default_task="translation"):
    ...
    # added by Eachan: for reorder mechanism
    parser.add_argument('--reorder', action='store_true', help='whether to use reordering embedding')
    parser.add_argument('--LS-reorder', action='store_true',
                        help='whether to use language-specific reordering embedding')
    parser.add_argument('--reorder-gate', action='store_true', help='whether to use gate for reordering embedding')
    parser.add_argument('--LS-dropout', action='store_true', help='whether to use language-specific dropout')
    parser.add_argument('--LA-reorder', action='store_true', help='whether to use language-aware reordering embedding')
    parser.add_argument('--RS-epoch', action='store_true', help='whether to use language-specific epoch mechanism')
    parser.add_argument('--online-distillation-MNMT', action='store_true',
                        help='whether to use online distillation for MNMT.')
    parser.add_argument('--single-teacher-MNMT', action='store_true',
                        help='whether to use single teacher online distillation for MNMT.')
    parser.add_argument('--fixed-teacher-MNMT', action='store_true',
                        help='whether to use fixed teacher online distillation for MNMT.')
    parser.add_argument('--online-distillation-warmup-epoch', default=1, type=int,
                        help='how many epochs do you want to use online distillation after.')
    parser.add_argument('--EMA', action='store_true',
                        help='whether to use EMA for online distillation.')
