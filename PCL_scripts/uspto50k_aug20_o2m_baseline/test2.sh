...
checkpoint_path="/root/autodl-tmp/Retro-SD/checkpoints/uspto50k_aug20_o2m/baseline2"
checkpoint_name=checkpoint144.pt
translate_path="/root/autodl-tmp/Retro-SD/results/baseline/144"
if [ -n "$2" ]; then
  checkpoint_name=$2
fi
...
python ${project_path}/PCL_scripts/uspto50k_aug20_o2m_baseline/result_statistics.py $TRANSLATION_DIR > ${TRANSLATION_DIR}/result.txt 2>&1