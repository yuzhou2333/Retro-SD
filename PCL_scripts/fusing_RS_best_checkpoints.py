"""
This scripts aims to fuse reaction-specific best checkpoints
"""
...
for lang_pair, loss_history in RS_valid_loss_history.items():
    if '-' in lang_pair:
        ...
        RS_best_epochs.append(loss_history.index(min(loss_history)) + 1)
...
inputs = [checkpoint_path + '/checkpoint' + str(epoch) + '.pt' for epoch in RS_best_epochs]
