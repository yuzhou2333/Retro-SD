...
checkpoint_path="/root/autodl-tmp/Retro-SD/checkpoints/uspto50k_aug20_o2m/FSL"
checkpoint_name=checkpoint3.pt
translate_path="/root/autodl-tmp/Retro-SD/results/fsl/3"
if [ -n "$2" ]; then
  checkpoint_name=$2
fi
...
python ${project_path}/PCL_scripts/uspto50k_aug20_o2m_sl/result_statistics.py $TRANSLATION_DIR > ${TRANSLATION_DIR}/result.txt 2>&1
