...
checkpoint_path="/root/autodl-tmp/Retro-SD/save_models/Retro_SD"
checkpoint_name=checkpoint210.pt
translate_path="/root/autodl-tmp/Retro-SD/results/Retro_SD3/210"
if [ -n "$2" ]; then
  checkpoint_name=$2
fi
