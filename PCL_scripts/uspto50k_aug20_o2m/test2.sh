...
# checkpoint_path="/root/autodl-tmp/Retro-SD/checkpoints/uspto50k_aug20_o2m/SD"
checkpoint_path="/root/autodl-tmp/Retro-SD/checkpoints/uspto50k_aug20_o2m/Retro_SD"
checkpoint_name=checkpoint225.pt
translate_path="/root/autodl-tmp/Retro-SD/results/Retro_SD/225"
if [ -n "$2" ]; then
  checkpoint_name=$2
fi
...
python ${project_path}/PCL_scripts/uspto50k_aug20_o2m/result_statistics.py $TRANSLATION_DIR > ${TRANSLATION_DIR}/result.txt 2>&1
