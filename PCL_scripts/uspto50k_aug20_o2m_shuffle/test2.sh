...
path_2_data=/root/autodl-tmp/Retro-SD/data_bin/uspto50k_aug20_o2m_shuffle
reaction_list=${path_2_data}/reaction_list.txt

checkpoint_path="/root/autodl-tmp/Retro-SD/checkpoints/uspto50k_aug20_o2m/shuffle"
checkpoint_name=checkpoint157.pt
translate_path="/root/autodl-tmp/Retro-SD/results/shuffle/157"
if [ -n "$2" ]; then
  checkpoint_name=$2
fi
...
python ${project_path}/PCL_scripts/uspto50k_aug20_o2m_shuffle/result_statistics.py $TRANSLATION_DIR > ${TRANSLATION_DIR}/result.txt 2>&1